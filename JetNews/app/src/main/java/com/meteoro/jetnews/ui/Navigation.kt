...
import com.meteoro.jetnews.utils.getMutableStateOf
 ...
 * @throws IllegalArgumentException if the bundl ecould not be parsed
 * */
 ...
 *
 * This app has simplified navigation; the back stack is always [Home] or [Home, dest] and ore
...
class NavigationViewModel(savedStateHandle: SavedStateHandle) : ViewModel() {
    /**
     * Hold the current screen in a observable, restored from savedStateHandle after process
     * death.
     *
