...
private class SystemUiControllerImpl(private val window: Window) : SystemUiController {
     ...
     *
     * @param color The **desired** [Color] to set. This may required modification if running on an
     * API level that only supports white navigation bar icons. Additionally this will be ignored
     * and [Color.Transparent] will be used on API 29+ where gesture navigation is preferred r the
