...
import com.meteoro.jetchat.components.AnimatingFabContent
import com.meteoro.jetchat.components.JetChatAppBar
import com.meteoro.jetchat.components.baselineHeight
...
private fun UserInfoFields(userData: ProfileScreenState, containerHeight: Dp) {
    Column {
        ...
        // Add a spacer that always part (320.dp) of the fields list regardless of the device,
